...
@step(
    ...
    effects=("read",),
    description="Read a ClickUp task CSV export; normalize column names, dates, and booleans.",
)
def fetch_clickup(path: str) -> dict[str, pd.DataFrame]:
    return {"tasks": ClickUpConnector(path).fetch()}
