...
@step(
    name="fetch_gcs",
    inputs={"bucket": str, "blob_path": str, "sheet_name": object, "nrows": object},
    outputs={"data": pd.DataFrame},
    effects=("read", "external_call"),
    description="Download a Google Cloud Storage xlsx blob and parse it as a DataFrame.",
)
def fetch_gcs(
    bucket: str,
    blob_path: str,
